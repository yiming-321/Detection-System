...
__all__ = ['Detect', 'Segment', 'Pose', 'Classify', 'RTDETRDecoder','MyDetect']
class MyDetect(nn.Module):
    ...
    def __init__(self, nc=80,myscale=1,ch=()):  # detection layer
        super().__init__()
        # if myscale==2:
        #     ch=[ch[0]]*2+[ch[1]]*2+[ch[2]]*2
        # elif myscale==5:
        #     ch=[ch[0]]*2+[ch[1]]*3+[ch[2]]*5
    ...
    def forward(self, x):
        ...
        # print("Detect"+   str(len(x))+"input  "+str(shape))
