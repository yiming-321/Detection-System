...
class DetectionTrainer(BaseTrainer):
    ...
    def get_dataloader(self, dataset_path, batch_size=16, rank=0, mode='train'):
        ...
        # return mybuild_dataloader(dataset, batch_size, workers, shuffle, rank)  # return dataloader
...
def train(cfg=DEFAULT_CFG, use_python=False):
    ...
    model = 'ultralytics/models/v8/myyolov8_1.yaml'
    data = '/home/rl/wyh/yolov8-deepsort-tracking-main/ultralytics/yolo/v8/detect/data.yaml'
    imgsz = 200
    device = cfg.device if cfg.device is not None else ''
    args = dict(model=model, data=data, imgsz=imgsz, device=device)
    if use_python:
